table 50128 Leave_Request_Table
{
    ...
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = Leave_Category_Table.Leave_Category_Name;
            trigger OnValidate()
            begin
        ...
        field(7; Approval_Status; Enum Leave_Status_Enum)
        {
            DataClassification = ToBeClassified;
            trigger OnValidate()
            begin
    ...
    var
        LeaveCategory: Record "Leave_Category_Table";
        LeaveRequests: Record "Leave_Request_Table";
        UsedDays: Integer;
    begin

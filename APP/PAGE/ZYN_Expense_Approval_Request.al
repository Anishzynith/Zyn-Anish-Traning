page 50180 ZYN_Expense_Approval_Request
{
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
        ...
        area(Processing)
        {
            action(Approve)
            {
                ...
                var
                    ...
                    ClaimCheckRec: Record ZYN_Expense_Claim_Table;
                    MaxDateAllowed: Date;
                begin
                    // 1. Check Status
                    if Rec.Claim_Status <> ZYN_Claim_status::Pending_Approval then
                    ...
                    // 5. Approve
                    Rec.Claim_Status := ZYN_Claim_status::Approved;
                    Rec.Modify(true);
            ...
            action(Reject)
            {
                ...
                begin
                    ...
                    if Confirm('Do you want to reject claim %1?', false, Rec.Exp_Id) then begin
                        Rec.Claim_Status := ZYN_Claim_status::Rejected;
                        Rec.Modify(true);
            ...
            action(ViewClaim)
            {
                Caption = 'View Claim';
                ApplicationArea = All;
                RunObject = page ZYN_Expense_Claim_Card;
    ...
    trigger OnOpenPage()
    begin
        Rec.SetRange(Claim_Status, ZYN_Claim_status::Pending_Approval); // Show only pending claims
    end;
    ...
    begin
        ...
        if ClaimCategoryRec.FindFirst() then begin
            ...
            ClaimHistory.SetRange(Claim_Status, ZYN_Claim_status::Approved);

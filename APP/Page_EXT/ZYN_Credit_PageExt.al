pageextension 50101 ZYN_CreditMemoExtension extends "Sales Credit Memo"
{
    layout
    {
        ...
        addlast(content)
        {
            ...
            part("Beginning Text Credit Memo"; "ZYN_Beginning Text Codes")
            {
                ApplicationArea = all;
            ...
            part("Ending Text Credit Memo"; "ZYN_Ending Text Codes")
            {
                ApplicationArea = all;

  codeunit 50112 "ZYN_Process Recurring Expenses"
{
    Subtype = Normal;
    trigger OnRun()
    var
        RecurringExpense: Record ZYN_Recurring_Expense_Table;
    begin
    ...
    local procedure CreateExpense(RecurringExpense: Record ZYN_Recurring_Expense_Table)
    var
        Expense: Record ZYN_Expense_Tracker;
    begin
        Expense.Init();
   ...
   local procedure UpdateNextDate(var RecurringExpense: Record ZYN_Recurring_Expense_Table)
    begin

    ...
    layout
    {
        area(Content)
        {
            repeater(GroupName)
            {
                ...
                // field("Expense_Category_ID"; Rec."Expense_Category_ID")
                // {
                //     ApplicationArea = All;
                ...
                // field(RemainingBudget; Rec.RemainingBudget)
                // {
                //     ApplicationArea = All;
    ...
    actions
    {
        area(Processing)
        {
            ...
            action(EXCEL)
            {
                ...
                // trigger OnAction()
                // begin
                //  //   Report.RunModal(Report::"Expense_Tracker_Report", false, false, Rec);
                // end;
